    ...
    <div class="flex">
        ...
        <div class="flex-1 p-6 min-w-0 flex flex-col overflow-hidden">
            ...
            <div class="py-5 flex flex-col gap-4 overflow-y-auto">
                ...
                <div class="bg-white border border-gray-200 rounded-xl p-4 flex items-center gap-3">
                    <div class="w-10 h-10 rounded-lg bg-yellow-100 flex items-center justify-center text-yellow-600 shrink-0">
                ...
                <div class="bg-white border border-gray-200 rounded-xl p-4 flex items-center gap-3">
                    <div class="w-10 h-10 rounded-lg bg-purple-100 flex items-center justify-center text-purple-700 shrink-0">
                ...
                <div class="bg-white border border-slate-200 rounded-xl shadow-sm p-5">
                    ...
                    <div class="flex items-end gap-2.5 flex-wrap">
                        <div class="flex flex-col gap-1">
                            <label
                                class="text-[10px] font-semibold text-slate-500 uppercase tracking-wide">Bulan</label>
                ...
                <div class="bg-white border border-slate-200 rounded-xl shadow-sm p-5">
                    ...
                    <div class="flex items-center gap-3 mt-3.5 text-[11px] text-slate-500 flex-wrap">
                        ...
                        <span class="flex items-center gap-1">
                            <span
                                class="inline-flex items-center justify-center w-4 h-4 rounded bg-green-100 text-green-700 text-[9px] font-bold">H</span>
                            Hadir
                        </span>
                        <span class="flex items-center gap-1">
                            <span
                                class="inline-flex items-center justify-center w-4 h-4 rounded bg-red-100 text-red-600 text-[9px] font-bold">A</span>
                            Alpha
                        </span>
                        <span class="flex items-center gap-1">
                            <span
                                class="inline-flex items-center justify-center w-4 h-4 rounded bg-yellow-100 text-yellow-700 text-[9px] font-bold">S</span>
                            Sakit
                        </span>
                        <span class="flex items-center gap-1">
                            <span
                                class="inline-flex items-center justify-center w-4 h-4 rounded bg-sky-100 text-sky-700 text-[9px] font-bold">I</span>
                            Izin
                        </span>
                        <span class="flex items-center gap-1">
                            <span
                                class="inline-flex items-center justify-center w-4 h-4 rounded bg-purple-100 text-purple-700 text-[9px] font-bold">L</span>
                            Lembur
                        </span>
                    ...
                    <div class="flex items-center justify-between mt-4 pt-4 border-t border-slate-100 flex-wrap gap-3">
                        ...
                        <div class="flex items-center gap-2">
                            <button
                                class="inline-flex items-center gap-1.5 border-2 border-red-400 text-red-600 hover:bg-red-50 font-semibold text-xs px-3.5 py-1.5 rounded-lg transition-colors">
                                <i class="fa-solid fa-xmark"></i> Tolak Rekap
                            </button>
                            <button
                                class="inline-flex items-center gap-1.5 bg-brand hover:bg-brand-dark text-white font-semibold text-xs px-3.5 py-1.5 rounded-lg transition-colors">
                ...
                <div class="bg-white border border-slate-200 rounded-xl shadow-sm p-5">
                    ...
                    <!-- Filter tanggal -->
                    <select
                        class="border border-slate-200 rounded-lg px-3 py-1.5 text-xs text-slate-600 bg-white focus:outline-none focus:ring-2 focus:ring-brand-mid">
