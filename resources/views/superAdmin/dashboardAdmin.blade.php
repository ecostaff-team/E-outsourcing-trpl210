...
<body class="bg-gray-100" style="font-family: 'Poppins', sans-serif;">
    ...
    <!-- TOPBAR -->
    <div
        class="bg-gradient-to-r from-green-900 to-green-700 px-10 h-16 flex items-center justify-between text-white shadow">
    ...
    <div class="p-4 md:p-8 lg:p-10">
        ...
        <p class="text-sm text-gray-500 mb-4">Tambah, ubah, dan hapus akun Admin Outsourcing, HR, dan Kepala Departemen
        </p>
