...
<body class="bg-gray-100" style="font-family: 'Poppins', sans-serif;">
    ...
    <div class="p-4 md:p-8 lg:p-10">
        ...
        <div class="bg-white p-8 rounded-lg shadow-lg mt-6">
            ...
            <div class="p-4 md:p-8 lg:p-10">
                <h1 class="text-2xl font-semibold">Kelola Akun Pengguna</h1>
                <p class="text-sm text-gray-500 mb-4">Tambah, ubah, dan hapus akun Admin Outsourcing, HR, dan
                    Kepala Departemen
                </p>
                ...
                <!-- TABS -->
                <div
                    class="bg-white px-4 md:px-10 border-gray-200 border-b border-t flex gap-6 text-sm overflow-x-auto">
                    <button onclick="switchTab('admin')" id="tabAdmin"
                        class="py-3 border-b-2 border-green-600 text-green-700 font-semibold">
                        Admin Outsourcing
                    </button>
                ...
                <div class="bg-white w-full max-w-xl rounded-xl overflow-y-auto shadow-lg">
                    ...
                    <div class="p-10 grid grid-cols-1 md:grid-cols-2 gap-6 text-sm">
                        <div>
                            ...
                            <input type="text" placeholder="Contoh: Rizky"
                        ...
                        <div>
                            ...
                            <input type="text" placeholder="Contoh: Darmawan"
                                class="w-full border border-gray-300 rounded-lg px-3 py-2 mt-1">
                        </div>
            ...
            <div id="modalHapus" class="fixed inset-0 bg-black/40 hidden items-center justify-center z-50 px-4">
                <div class="bg-white w-full max-w-md rounded-2xl shadow-lg text-center p-6">
                    ...
                    <p class="text-sm text-gray-500 mb-6">
                        Akun <span id="namaHapus" class="font-semibold text-gray-700"></span> akan dihapus
                        permanen.<br>
                    ...
                    <div class="flex flex-col md:flex-row gap-3 justify-center">
                        <button onclick="closeHapus()"
                            class="px-4 py-2 border rounded-lg w-full md:w-auto">Batal</button>
                        <button class="px-4 py-2 bg-red-600 text-white rounded-lg w-full md:w-auto">Ya,
                            Hapus</button>
                    </div>
