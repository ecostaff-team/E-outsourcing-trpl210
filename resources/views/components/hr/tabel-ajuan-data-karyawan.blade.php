    ...
    <table class="w-full text-sm border-separate border-spacing-y-2">
        <thead class="bg-green-100 text-gray-600">
            <tr class="shadow-sm border border-gray-100">
                <th class="p-2 md:p-3 text-center text-xs md:text-sm w-12">No</th>
                <th class="p-2 md:p-3 text-left text-xs md:text-sm">NIP</th>
                <th class="p-2 md:p-3 text-left text-xs md:text-sm text-center uppercase">Nama Karyawan</th>
                <th class="p-2 md:p-3 text-center text-xs md:text-sm w-32">AKSI</th>
            </tr>
        </thead>
        ...
        <tbody>
            <tr onclick="openModal('240029222', 'Fairuz Kamala', 'fairuz.k@ecogreen.id', '081233445566', 'Jl. Sudirman No. 10', 'PT. EcoGreen')" 
                ...
                <td class="p-3 text-left font-mono">240029222</td>
                <td class="p-3 text-left text-center">Fairuz Kamala</td>
                <td class="p-3 text-center">
                    <button onclick="event.stopPropagation(); alert('Diterima')" class="bg-green-500 hover:bg-green-600 transition text-white px-2 py-1 rounded shadow-sm">
                        <i class="fas fa-check"></i>
                    </button>
                    <button onclick="event.stopPropagation(); alert('Ditolak')" class="bg-red-500 hover:bg-red-600 transition text-white px-2 py-1 rounded shadow-sm">
            ...
            <tr onclick="openModal('240029223', 'Ahmad Syauqi', 'ahmad.s@syauqi.com', '085711223344', 'Perum Harapan Indah', 'PT. TechSolution')" 
                ...
                <td class="p-3 text-left font-mono">240029223</td>
                <td class="p-3 text-left text-center">Ahmad Syauqi</td>
                <td class="p-3 text-center">
                    <button onclick="event.stopPropagation();" class="bg-green-500 hover:bg-green-600 transition text-white px-2 py-1 rounded shadow-sm"><i class="fas fa-check"></i></button>
                    <button onclick="event.stopPropagation();" class="bg-red-500 hover:bg-red-600 transition text-white px-2 py-1 rounded shadow-sm"><i class="fas fa-xmark"></i></button>
                </td>
            </tr>
            ...
            <tr onclick="openModal('240029224', 'Nabila Putri', 'nabila.p@gmail.com', '081988776655', 'Apartemen Menteng Atas', 'PT. CreativeDev')" 
                ...
                <td class="p-3 text-left font-mono">240029224</td>
                <td class="p-3 text-left text-center">Nabila Putri</td>
                <td class="p-3 text-center">
                    <button onclick="event.stopPropagation();" class="bg-green-500 hover:bg-green-600 transition text-white px-2 py-1 rounded shadow-sm"><i class="fas fa-check"></i></button>
                    <button onclick="event.stopPropagation();" class="bg-red-500 hover:bg-red-600 transition text-white px-2 py-1 rounded shadow-sm"><i class="fas fa-xmark"></i></button>
                </td>
            ...
            <tr onclick="openModal('240029225', 'Dimas Anggara', 'dimas.an@outlook.com', '082155667788', 'Jl. Melati No. 45', 'PT. GlobalMaju')" 
                ...
                <td class="p-3 text-left font-mono">240029225</td>
                <td class="p-3 text-left text-center">Dimas Anggara</td>
                <td class="p-3 text-center">
                    <button onclick="event.stopPropagation();" class="bg-green-500 hover:bg-green-600 transition text-white px-2 py-1 rounded shadow-sm"><i class="fas fa-check"></i></button>
                    <button onclick="event.stopPropagation();" class="bg-red-500 hover:bg-red-600 transition text-white px-2 py-1 rounded shadow-sm"><i class="fas fa-xmark"></i></button>
                </td>
            ...
            <tr onclick="openModal('240029226', 'Rina Melati', 'rina.m@perusahaan.com', '089944332211', 'Cluster Pinang Mas', 'PT. SumberDana')" 
                ...
                <td class="p-3 text-left font-mono">240029226</td>
                <td class="p-3 text-left text-center">Rina Melati</td>
                <td class="p-3 text-center">
                    <button onclick="event.stopPropagation();" class="bg-green-500 hover:bg-green-600 transition text-white px-2 py-1 rounded shadow-sm"><i class="fas fa-check"></i></button>
                    <button onclick="event.stopPropagation();" class="bg-red-500 hover:bg-red-600 transition text-white px-2 py-1 rounded shadow-sm"><i class="fas fa-xmark"></i></button>
                </td>
            ...
            <tr onclick="openModal('240029227', 'Bima Sakti', 'bima.s@space.id', '081233440099', 'Jl. Antariksa No. 1', 'PT. GalaksiJaya')" 
                ...
                <td class="p-3 text-left font-mono">240029227</td>
                <td class="p-3 text-left text-center">Bima Sakti</td>
                <td class="p-3 text-center">
                    <button onclick="event.stopPropagation();" class="bg-green-500 hover:bg-green-600 transition text-white px-2 py-1 rounded shadow-sm"><i class="fas fa-check"></i></button>
                    <button onclick="event.stopPropagation();" class="bg-red-500 hover:bg-red-600 transition text-white px-2 py-1 rounded shadow-sm"><i class="fas fa-xmark"></i></button>
                </td>
            ...
            <tr onclick="openModal('240029228', 'Thoiriq Muchlisqism', 'thoiriq.m@racing.com', '087766554433', 'Kavling Sirkuit No. 7', 'PT. FastSpeed')" 
                ...
                <td class="p-3 text-left font-mono">240029228</td>
                <td class="p-3 text-left text-center">Thoiriq Muchlisqism</td>
                <td class="p-3 text-center">
                    <button onclick="event.stopPropagation();" class="bg-green-500 hover:bg-green-600 transition text-white px-2 py-1 rounded shadow-sm"><i class="fas fa-check"></i></button>
                    <button onclick="event.stopPropagation();" class="bg-red-500 hover:bg-red-600 transition text-white px-2 py-1 rounded shadow-sm"><i class="fas fa-xmark"></i></button>
                </td>
