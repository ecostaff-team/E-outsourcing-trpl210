        ...
        <tbody>
            <tr class="odd:bg-white even:bg-gray-100 shadow-sm hover:bg-green-50 transition cursor-pointer">
                ...
                <td class="p-3 text-center whitespace-nowrap">
                    <div class="flex justify-center items-center gap-2">
                        <button class="bg-yellow-500 hover:bg-yellow-600 transition text-black px-2 py-1 rounded shadow-sm"><i class="fas fa-pen"></i></button>
                        <button class="bg-red-500 hover:bg-red-600 transition text-white px-2 py-1 rounded shadow-sm"><i class="fas fa-trash"></i></button>
                    </div>
                </td>
            </tr>
            ...
            <tr class="odd:bg-white even:bg-gray-100 shadow-sm hover:bg-green-50 transition cursor-pointer text-gray-500">
                ...
                <td class="p-3 text-center whitespace-nowrap">
                    <div class="flex justify-center items-center gap-2">
                        <button class="bg-yellow-500 hover:bg-yellow-600 transition text-black px-2 py-1 rounded shadow-sm"><i class="fas fa-pen"></i></button>
                        <button class="bg-gray-400 hover:bg-gray-500 transition text-white px-2 py-1 rounded shadow-sm cursor-not-allowed" disabled><i class="fas fa-trash"></i></button>
                    </div>
                </td>
            </tr>
