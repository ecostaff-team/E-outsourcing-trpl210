    ...
    <div>
        ...
        <ul id="sidebar-menu" class="mt-8 ml-4">
            @foreach ($menus as $menu)
                ...
                <li>
                    <a href="{{ $menu['ref'] }}"
                        class="flex items-center gap-3 text-md font-medium pl-4 py-2 rounded-xl rounded-tr-none rounded-br-none transition-all duration-300 my-2
            {{ $isActive
                ? 'bg-white/75 text-gray-700 shadow-inner hover:bg-linear-to-r hover:to-green-400 from-white/20 hover:-translate-y-0.5'
                : 'hover:bg-linear-to-r hover:to-green-400 from-white/20 hover:-translate-y-1 ' }}">
