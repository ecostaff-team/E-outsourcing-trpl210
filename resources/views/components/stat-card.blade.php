...
<div class="bg-white rounded-xl p-2 shadow-sm border-2 {{ $borderColor }} flex items-center gap-4 relative transition-all duration-300 hover:-translate-y-0.5 hover:shadow-xl">
    ...
    <div class="flex-1 text-center pr-6">
        ...
        <h3 class="text-3xl font-extrabold {{ $textColor }} my-1">{{ $value }}</h3>
